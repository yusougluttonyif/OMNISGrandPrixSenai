...
Eu não testei o site no celular, então recomendo entrar no PC.
É minha primeira vez fazendo um site site mesmo, sem ser para apresentação de trabalho / projeto por diversão e aprendizado.
